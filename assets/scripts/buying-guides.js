...
class BuyingGuidesManager {
    ...
    renderGuides() {
        const guidesShowcase = document.querySelector('.product-buying-guides-showcase');
        if (!guidesShowcase) return;

        // Combine featured guide with regular guides
        const allGuides = [this.featuredGuide, ...this.guides];
        
        // Shuffle the guides array to show different ones on each refresh
        const shuffledGuides = this.shuffleArray([...allGuides]);
        
        // Show only 3 guides
        const guidesToShow = shuffledGuides.slice(0, 3);

        guidesShowcase.innerHTML = guidesToShow.map(guide => `
            <div class="buying-guide-card" onclick="buyingGuidesManager.openGuideModal('${guide.id}')">
                ...
                <div class="guide-card-content">
                    ...
                    <div class="guide-meta">
                        ...
                        ${guide.difficulty ? `<div class="guide-difficulty">
